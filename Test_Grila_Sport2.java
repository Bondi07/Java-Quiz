...
public class Test_Grila_Sport2 implements ActionListener {


    String[] questionsSportHard = {
            "Ce fel de cursa este Giro d'Italia?",
            "Care sport este cel mai popular din lume?",
            "Care tara a fost singura care a participat la fiecare Cupa Mondiala?",
            "Cum se numeste jocul in care mingea sare de pe perete?",
            "Cine a fost prima femeie care a jucat golf?"

    };
    String[][] optionsSportHard =
            {
                    {"Ciclism","Curse de masini","Cursa de cai"},
                    {"Ciclism","Futbal","Tenis"},
                    {"Brazil", "Germania", "Rusia"},
                    {"Squash","Baschet","Pelota"},
                    {"Maria","Ana","Ana Maria"}
            };
    char[] answersSportHard =
            {
                    'A',
                    'B',
                    'A',
    ...
    int total_questions = questionsSportHard.length;
    int results;
    int seconds = 10;
    ...
    public Test_Grila_Sport2()
    {
        frame4.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        frame4.setSize(750, 700);
        frame4.getContentPane().setBackground(new Color(50, 50, 50));
        frame4.setLayout(null);
        frame4.setResizable(false);
        frame4.setVisible(true);
        frame4.setTitle("Test GrilaSport");
        ...
        labelA.setBounds(250,200,300,30);
        ...
        labelB.setBounds(250,300,300,30);
        ...
        labelC.setBounds(250,400,300,30);
        ...
        frame4.add(buttonMain);
        frame4.add(labelC);
        frame4.add(labelB);
        frame4.add(labelA);
        frame4.add(radioButtonC);
        frame4.add(radioButtonB);
        frame4.add(radioButtonA);
        frame4.add(textarea1);
        frame4.add(textfield1);
        frame4.add(seconds_left);
        frame4.add(time_label);
        frame4.setVisible(true);
    ...
    ///progres bar ne radi ne ponavlja se treba sa actionperformed
    ...
    public void nextQuestion()
    {
        ...
        else
        {
            ...
            textarea1.setText(questionsSportHard[index]);
            labelA.setText(optionsSportHard[index][0]);
            labelB.setText(optionsSportHard[index][1]);
            labelC.setText(optionsSportHard[index][2]);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            answer = 'A';
            if (answer ==answersSportHard[index])
            {
                corect_quesses++;
            }
        }
    ...
    public void displayAnswer()
    {
        ...
        if (answersSportHard[index] != 'A')
            labelA.setForeground(new Color(255,0,0));
        if (answersSportHard[index] != 'B')
            labelB.setForeground(new Color(255,0,0));
        if (answersSportHard[index] != 'C')
    ...
    private void results()
    {
        ...
        frame4.add(percentage);
        frame4.add(number_right);
