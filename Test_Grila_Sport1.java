...
public class Test_Grila_Sport1 implements ActionListener {


    String[] questionsSportMedium = {
            "Cat dureaza un meci de rugby?",
            "Omnium este un eveniment in care sport?",
            "Cate sferturi are un joc de hocei?",
            "Ce face un baiat cu minge in timpul unui meci de tenis?",
            "In ce sport este faimos Michael Jordan?"

    };
    String[][] optionsSportMedium =
            {
                    {"60min","90min","80min"},
                    {"Ciclism","Futbal","Tenis"},
                    {"2 sverturi", "3 sverturi", "4 sverturi"},
                    {"El aduna mingi","Aduce echipament","Judeca meciul"},
                    {"Hochei","Fudbal","Baschet"}
            };
    char[] answersSportMedium =
            {
                    'C',
                    'A',
                    'B',
    ...
    int total_questions = questionsSportMedium.length;
    int results;
    int seconds = 10;
    ...
    public Test_Grila_Sport1()
    {
        frame3.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        frame3.setSize(750, 700);
        frame3.getContentPane().setBackground(new Color(50, 50, 50));
        frame3.setLayout(null);
        frame3.setResizable(false);
        frame3.setVisible(true);
        frame3.setTitle("Test GrilaSport");
        ...
        number_right.setBounds(280,250,200,100);
        ...
        percentage.setBounds(280,350,200,100);
        ...
        frame3.add(buttonMain);
        frame3.add(labelC);
        frame3.add(labelB);
        frame3.add(labelA);
        frame3.add(radioButtonC);
        frame3.add(radioButtonB);
        frame3.add(radioButtonA);
        frame3.add(textarea1);
        frame3.add(textfield1);
        frame3.add(seconds_left);
        frame3.add(time_label);
        frame3.setVisible(true);
    ...
    public void nextQuestion()
    {
        ...
        else
        {
            ...
            textarea1.setText(questionsSportMedium[index]);
            labelA.setText(optionsSportMedium[index][0]);
            labelB.setText(optionsSportMedium[index][1]);
            labelC.setText(optionsSportMedium[index][2]);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            answer = 'A';
            if (answer ==answersSportMedium[index])
            {
                corect_quesses++;
            }
        }
    ...
    public void displayAnswer()
    {
        ...
        if (answersSportMedium[index] != 'A')
            labelA.setForeground(new Color(255,0,0));
        if (answersSportMedium[index] != 'B')
            labelB.setForeground(new Color(255,0,0));
        if (answersSportMedium[index] != 'C')
    ...
    private void results()
    {
        ...
        frame3.add(percentage);
        frame3.add(number_right);
